layui.define(['table', 'jquery', 'form', 'tab', 'menu', 'frame'],
	...
	function(exports) {
		...
		$("body").on("click", ".setting", function() {
			...
			var html =
				...
				'<div class="color-title">整体风格-曹</div>\n' +
		...
		function buildColorHtml() {
			...
			return "<div class='select-color'><div class='select-color-title'>主题色-韩</div><div class='select-color-content'>" +
				colors + "</div></div>"
		}
